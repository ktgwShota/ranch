...
import { Box, Paper, Typography, LinearProgress, Avatar, Divider, Chip, Alert, Button } from '@mui/material';
import { BarChart as BarChartIcon, HowToVote as HowToVoteIcon, People as PeopleIcon, Star as StarIcon, Campaign as CampaignIcon } from '@mui/icons-material';
  ...
  return (
    <>
      <LinkNotificationBanner
        title={hasSchedule ? '出欠表（日程調整）が作成されています！' : '日程はもう決まりましたか？'}
        description={
          hasSchedule
